...
export declare class WalletDAO {
    ...
    sendARToAddress(arAmount: AR, fromWallet: Wallet, toAddress: ArweaveAddress, rewardSettings: RewardSettings | undefined, dryRun: boolean | undefined, [{ value: appName }, { value: appVersion }, { value: txType }, ...otherTags]: GQLTagInterface[], assertBalance?: boolean): Promise<ARTransferResult>;
}
