...
function driveEncrypt(driveKey, data) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const cipher = crypto.createCipheriv(algo, driveKey, iv, { authTagLength: constants_1.authTagLength });
...
function fileEncrypt(fileKey, data) {
    return __awaiter(this, void 0, void 0, function* () {
        const iv = crypto.randomBytes(12);
        const cipher = crypto.createCipheriv(algo, fileKey, iv, { authTagLength: constants_1.authTagLength });
...
function driveDecrypt(cipherIV, driveKey, data) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const decipher = crypto.createDecipheriv(algo, driveKey, iv, { authTagLength: constants_1.authTagLength });
...
function fileDecrypt(cipherIV, fileKey, data) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const encryptedDataSlice = data.slice(0, data.byteLength - constants_1.authTagLength);
            const iv = Buffer.from(cipherIV, 'base64');
            const decipher = crypto.createDecipheriv(algo, fileKey, iv, { authTagLength: constants_1.authTagLength });
            decipher.setAuthTag(authTag);
